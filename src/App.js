...
const renderFlight = ({ pairing }) => {
  //the app will represent each list item via a Text component
  return <Text style={styles.flightitem}> {pairing.ID}</Text>;
};
    ...
    {data && (
      <View style={styles.mylist}>
        <FlatList
         ...
         renderItem={renderFlight} //tell React to use our renderItem function that we defined earlier
          />
      </View>
    )}
